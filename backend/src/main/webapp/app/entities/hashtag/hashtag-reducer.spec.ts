...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './hashtag.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HASHTAG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HASHTAG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HASHTAG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HASHTAG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HASHTAG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HASHTAG actions', async () => {
      const arg = 42666;
