...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './spark.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPARK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SPARK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SPARK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SPARK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SPARK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SPARK actions', async () => {
      const arg = 42666;
