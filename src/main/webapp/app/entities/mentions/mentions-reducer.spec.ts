...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './mentions.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MENTIONS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MENTIONS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MENTIONS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MENTIONS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MENTIONS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MENTIONS actions', async () => {
      const arg = 42666;
