...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './likes.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIKES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LIKES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LIKES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LIKES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LIKES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LIKES actions', async () => {
      const arg = 42666;
