...
const GPT3Component = ({ apiKey, onUpdateInputValue }) => {
  ...
  const globeIcon = (
    <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" className="bi bi-globe2" viewBox="0 0 16 16">
  ...
  const generateText = () => {
    ...
    axios.post('https://api.openai.com/v1/completions', {
      ...
      prompt: `Translate this to ${language}: ${inputText}`,
      max_tokens: 1000
    }, {
      headers: {
